...
export function fixture(templateId: TemplateId = 'minimal', count = 2): InvoiceViewModel {
  return {
    ...
    seller: { name: 'فروشگاه نمونه بهار', subtitle: 'تولید و فروش کالا و خدمات', legalId: '۱۴۰۰۵۸۹۳۰۱۰', economicId: '۴۱۱۵۳۸۱۹۸۱۳۵', phone: '021-88888888', address: 'تهران، خیابان نمونه، پلاک ۱۲', email: 'info@example.ir' },
    customer: { name: 'شرکت مشتری نمونه', legalId: '۱۴۰۰۷۵۱۱۹۹', postalCode: '۳۱۷۴۸۲۶۴۱۱', phone: '026-9100904', address: 'البرز، شهرک صنعتی، خیابان نمونه' },
    ...
    payment: { cardNumber: '۶۲۱۹-۸۶۱۰-۰۰۰۰-۰۰۰۰', sheba: 'IR۰۰۰۰۰۰۰۰۰۰۰۰۰۰۰۰۰۰۰۰۰۰۰', bankName: 'بانک نمونه', accountHolder: 'فروشگاه بهار' },
