...
export interface InvoiceViewModel{
  ...
  signature?:{sellerLabel?:string;customerLabel?:string;showStampArea?:boolean}; templateId:TemplateId; templateVersion:1; orientation:TemplateOrientation; accent?:string;
}
